            ...
            <article class="card">
                ...
                <a href="assets/pages/liberdade.php" target="_blank">
                    <div class="card-content">
                        ...
                        <h2 class="card-title">Liberdade<br>Sistêmica</h2>
                        <p class="card-description">Transforme sua vida e alcance a verdadeira liberdade interior.</p>
                        <div class="card-arrow">
                            <div class="card-arrow__line"></div>
                            <div class="card-arrow__head"></div>
                        </div>
                    </div>
            ...
            <article class="card">
                ...
                <a href="assets/pages/raizes.php" target="_blank">
                    <div class="card-content">
                        ...
                        <h2 class="card-title">Raízes<br>do Corpo</h2>
                        <p class="card-description">Onde a dor física encontra a sua raiz emocional.</p>
                        <div class="card-arrow">
                            <div class="card-arrow__line"></div>
                            <div class="card-arrow__head"></div>
                        </div>
            ...
            <article class="card">
                ...
                <a href="https://api.whatsapp.com/send/?phone=5516996180382&text=Ol%C3%A1%2C+gostaria+de+saber+mais+sobre+a+Mentoria+Liberdade+Sist%C3%AAmica&type=phone_number&app_absent=0" target="_blank">
                    <div class="card-content">
                        ...
                        <h2 class="card-title">Fale<br>Comigo</h2>
                        <p class="card-subtitle">no WhatsApp</p>
                        <p class="card-description">Tire suas dúvidas e inicie sua jornada de transformação.</p>
                        <div class="card-arrow">
                            <div class="card-arrow__line"></div>
                            <div class="card-arrow__head"></div>
                        </div>
